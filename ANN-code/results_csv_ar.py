"""
evaluate_model_3class.py

This script loads a trained LENRI_Ar_CF4_3 model, evaluates it on a three-class test dataset,
...
from models import LENRI_Ar_CF4_3
...
# Function to extract labels from filenames for 3-class classification
...
def evaluate_model():
    ...
    results_df = pd.DataFrame({
        ...
        "Predict_Ar": [p[2] for p in all_probs],  # Softmax probability for class Ar
    })
...
def plot_confusion_matrix(labels, preds):
    ...
    sns.heatmap(cm, annot=True, fmt="d", cmap="Blues", xticklabels=["C", "F", "Ar"], yticklabels=["C", "F", "Ar"])
